...
export default function Formulario3() {
 ...
 <div className="container mt-5">
   ...
   <div className="mb-5">
                ...
                {carroSelecionado && (
    <div 
        className="mt-4 p-3 border rounded col-md-4"
        style={{ 
            // Usa o ID do carro para pegar um índice do array de cores 
            backgroundColor: coresBackground[carroSelecionado.id % coresBackground.length] 
        }}
    >
